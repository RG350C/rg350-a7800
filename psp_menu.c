...
psp_display_screen_menu(void)
{
  ...
  if (ATARI.atari_save_state[cur_slot].thumb) {
    psp_sdl_blit_thumb(180, 30, ATARI.atari_save_state[cur_slot].surface);
  } else {
    psp_sdl_blit_thumb(180, 30, thumb_surface);
  }
...
psp_main_menu_reset(void)
{
  ...
  psp_sdl_back2_print(120, 125, "Reset Atari !", 
...
psp_main_menu_load(int format)
{
  ...
  if (ret ==  1) /* load OK */
  {
    psp_menu_dirty = 1;
    psp_display_screen_menu();
    psp_sdl_back2_print(120, 125, "File loaded !", 
                       PSP_MENU_NOTE_COLOR);
    psp_menu_dirty = 1;
    psp_sdl_flip();
    sleep(1);
  ...
  if (ret == -1) /* Load Error */
  {
    psp_menu_dirty = 1;
    psp_display_screen_menu();
    psp_sdl_back2_print(120, 125, "Can't load file !", 
                       PSP_MENU_WARNING_COLOR);
    psp_menu_dirty = 1;
    psp_sdl_flip();
    sleep(1);
...
psp_main_menu_load_slot()
{
  ...
  if (! ATARI.atari_save_state[cur_slot].used) {
    ...
    psp_display_screen_menu();
    psp_sdl_back2_print(120, 125, "Slot is empty !", 
                       PSP_MENU_NOTE_COLOR);
    psp_menu_dirty = 1;
    psp_sdl_flip();
    sleep(1);
...
psp_main_menu_save_slot()
{
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print(120, 125, "File saved !", 
                       PSP_MENU_NOTE_COLOR);
    psp_menu_dirty = 1;
    psp_sdl_flip();
    sleep(1);
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print(120, 125, "Can't save file !", 
                       PSP_MENU_WARNING_COLOR);
    psp_menu_dirty = 1;
    psp_sdl_flip();
    sleep(1);
...
psp_main_menu_del_slot()
{
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print(120, 125, "File deleted !", 
                       PSP_MENU_NOTE_COLOR);
    psp_menu_dirty = 1;
    psp_sdl_flip();
    sleep(1);
  ...
  {
    psp_display_screen_menu();
    psp_sdl_back2_print(120, 125, "Can't delete file !", 
                       PSP_MENU_WARNING_COLOR);
    psp_menu_dirty = 1;
    psp_sdl_flip();
    sleep(1);
